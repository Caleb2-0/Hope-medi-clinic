...
{
    public partial class recDashboard : Form
    {
        ...
        public static recDashboard instance;
        public Label plb;
        login log = new login();
        public recDashboard()
        {
            ...
            recBut1 = new Rectangle(btnC.Location, btnC.Size);
            recTxt1 = new Rectangle(btnS.Location, btnS.Size);
            recPnl1 = new Rectangle(btnA.Location, btnA.Size);
            recPnl2 = new Rectangle(btnT.Location, btnT.Size);
        ...
        {
            resize_Control(btnC, recBut1);
            resize_Control(btnS, recTxt1);
            resize_Control(btnA, recPnl1);
            resize_Control(btnT, recPnl2);
        ...
        private void recDashboard_Load(object sender, EventArgs e)
        {
            label3.Text = uname;
